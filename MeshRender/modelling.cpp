...
void initBuffersGL(void)
{
  ...
  shape_t* dummy_shape = new dummy_t(0);
  dummy_shape -> draw();
  node1 = new csX75::HNode(NULL,dummy_shape -> num_vertices,v_positions,v_colors,sizeof(v_positions),0);
  root_node = node1;
  curr_node = node1;
  curr_node -> shape_pointer = dummy_shape;
...
{
  if(new_shape != 0){
      curr_node ->  csX75::HNode::addShape(new_shape);
      new_shape = 0;
  }
